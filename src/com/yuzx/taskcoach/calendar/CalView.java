...
// * 
// */
//package com.yuzx.taskcoach.calendar;
//
...
// *
// */
//public class CalView extends BaseAdapter {
//
//	public CalView (){
//		
//	}
...
import com.yuzx.taskcoach.calendar.LunarCalendar;
import com.yuzx.taskcoach.calendar.SpecialCalendar;
...
//	private ScheduleDAO dao = null;
	...
	public CalView(Context context,Resources rs,int jumpMonth,int jumpYear,int year_c,int month_c,int day_c){
		this();
	...
	public CalView(Context context,Resources rs,int year, int month, int day){
		this();
		this.context= context;
		sc = new SpecialCalendar();
		lc = new LunarCalendar();
